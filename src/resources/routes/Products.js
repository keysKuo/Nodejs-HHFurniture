...
const { VALIDATE_productCreate, VALIDATE_productUpdate } = require('../middlewares/validators');
...
router.post('/update/:id', upload.array('products', 12), VALIDATE_productUpdate, Controller_Products.POST_updateProduct);
