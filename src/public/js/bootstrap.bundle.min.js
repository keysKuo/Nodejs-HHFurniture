...
!(function (t, e) {
                      ...
                      return function s(n) {
                          ...
                          for (let { target: e } = n; e && e !== this; e = e.parentNode)
                              for (let r = o.length; r--; )
                                  if (o[r] === e)
                                      return (n.delegateTarget = e), s.oneOff && N.off(t, n.type, i), i.apply(e, [n]);
                          return null;
                      };
                  })(t, i, s)
                : (function (t, e) {
    ...
    class Y extends j {
        ...
        _getItemIndex(t) {
            return (
                (this._items = t && t.parentNode ? H.find('.carousel-item', t.parentNode) : []), this._items.indexOf(t)
            );
        }
        _getItemByOrder(t, e) {
            const i = t === $,
    ...
    function xt(t) {
        ...
        return a
            ...
            : Object.assign(
                  {},
                  A,
                  (((e = {})[b] = m ? p + 'px' : ''), (e[_] = g ? f + 'px' : ''), (e.transform = ''), e),
              );
    }
    var Ct = {
            name: 'computeStyles',
    ...
    class Be extends j {
        ...
        show() {
            ...
            const f =
                'function' == typeof this.config.customClass ? this.config.customClass() : this.config.customClass;
        ...
        _getConfig(t) {
            ...
            return (
                ...
                'number' ==
                    typeof (t = { ...this.constructor.Default, ...e, ...('object' == typeof t && t ? t : {}) }).delay &&
